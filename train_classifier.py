...
cate2label = {'CK+':{0: 'Happy', 1: 'Angry', 2: 'Fear',
              ...
              'AFEW':{0: 'surprise', 1: 'repression', 2: 'happiness', 3: 'disgust', 4: 'others',
...
def main(config):
    ...
    '''
    root_train = './data1/all2'
    list_train = './data1/5class_train17.txt'
    ...
    train_dataset = ImageFolder("/home/prmi/zy/few-shot-meta-baseline-master/materials/train_ck+",
                                transform=default_transform)
    ...
    if config.get('val_dataset'):
        ...
        eval_val = True
        '''
        root_eval = './data1/all2'
        list_eval = './data1/5class_eval17.txt'
        ...
        val_dataset = ImageFolder("/home/prmi/zy/few-shot-meta-baseline-master/materials/test_ck+",
                                    transform=default_transform)
    ...
    if config.get('fs_dataset'):
        ...
        fs_dataset = ImageFolder("/home/prmi/zy/few-shot-meta-baseline-master/materials/test_casme2",
                                    transform=default_transform)
        utils.log('fs dataset: {} (x{}), {}'.format(
            fs_dataset[0][0].shape, len(fs_dataset),
            len(fs_dataset.classes)))
        # if config.get('visualize_datasets'):  # 'visualize_datasets': True
        #    utils.visualize_dataset(train_dataset, 'train_dataset', writer)
        n_way = 4
        n_query = 2
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser() #创建解析器 python train_classifier.py --config configs/train_classifier_mini.yaml
